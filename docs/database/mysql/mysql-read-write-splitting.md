...
![image-20211102202811002](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/image-20211102202811002.png)
...
![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_01.png)
...
![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_12.png)
...
![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_05.png)

- 通过Navicat分别连接到主库和从库，用于查看数据，此时建立了以下三个数据库连接；

![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_06.png)

- 通过`stop slave`命令关闭`mysql-slave`实例的主从复制功能：

![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_07.png)

- 通过Gaea代理在`test`表中插入一条数据：

![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_08.png)

- 在主库中查看`test`表的数据，发现已有该数据：

![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_09.png)

- 在从库中查看`test`表的数据，发现没有该数据，证明写操作走的是主库：

![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_10.png)

- 直接在代理中查看`test`表中的数据，发现没有该数据，证明读操作走的是从库。

![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/database/mysql/gaea_use_11.png)
