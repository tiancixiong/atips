...
![aqs_1](//gcore.jsdelivr.net/gh/tiancixiong/atips@img-230529/images/java/concurrent/aqs_1.png)
...
![aqs_2](//gcore.jsdelivr.net/gh/tiancixiong/atips@img-230529/images/java/concurrent/aqs_2.png)

![aqs_3](//gcore.jsdelivr.net/gh/tiancixiong/atips@img-230529/images/java/concurrent/aqs_3.png)

详细流程可以用下图来表示，请结合源码来理解（一图胜千言）：

![aqs_4](//gcore.jsdelivr.net/gh/tiancixiong/atips@img-230529/images/java/concurrent/aqs_4.png)
