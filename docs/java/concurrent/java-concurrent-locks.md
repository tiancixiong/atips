...
> :bell: 注意：事实上，解决此类问题使用 `CountDownLatch`、`Semaphore` 等工具更为便捷、安全。
...
![aqs_1](//tiancixiong.coding.net/p/atips-cdn/d/atips-cdn/git/raw/images/images/java/concurrent/aqs_1.png)
...
![aqs_2](//tiancixiong.coding.net/p/atips-cdn/d/atips-cdn/git/raw/images/images/java/concurrent/aqs_2.png)

![aqs_3](//tiancixiong.coding.net/p/atips-cdn/d/atips-cdn/git/raw/images/images/java/concurrent/aqs_3.png)

详细流程可以用下图来表示，请结合源码来理解（一图胜千言）：

![aqs_4](//tiancixiong.coding.net/p/atips-cdn/d/atips-cdn/git/raw/images/images/java/concurrent/aqs_4.png)
