...
消息队列（Message Queue）是一种应用间的通信方式。消息队列是典型的 *生产者-消费者* 模型。生产者不断向消息队列中生产消息，消费者不断的从队列中获取消息。因为消息的生产和消费都是异步的，而且只关心消息的发送和接收，没有业务逻辑的侵入，这样就实现了生产者和消费者的解耦。
 ...
 ![image-20211112161717225](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/mq/image-20211112161717225.png)
...
1. **解耦**
   ...
   ![img](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/mq/image-20211112161554428.png)
...
2. **异步**
   ...
   ![image-20211112161832548](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/mq/image-20211112161832548.png)
...
3. **削峰**，通过异步处理，将短时间高并发产生的事务消息存储在消息队列中，从而削平高峰期的并发事务。
   ...
   ![image-20211112162014339](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/mq/image-20211112162014339.png)
...
![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/mq/20201124141849.png)
...
![](//www.jsdelivr.ren/gh/tiancixiong/atips@img-230529/images/mq/20201124141856.png)
